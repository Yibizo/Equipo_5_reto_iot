...
while(1):
    ...
    try:
        line = dataFromClient.decode("ascii")
        line = line.rstrip()
        medidas = line.split(";")
    ...
    if len(hrValues) == 100:
        ox_sat = calc_hr_and_spo2(irValues, redValues)
        ...
        try:
            ...
            if ox_sat[3]:
                ...
                query_data = {'user_id': 1, 'date': dt_string, 'ox_sat': ox_sat[2], 'bpm': bpm, 'state': state}
